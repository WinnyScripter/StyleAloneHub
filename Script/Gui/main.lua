...
local function AddConnection(Signal, Function)
	if (not StyleAloneHub:IsRunning()) then
		return
	end
	local SignalConnect = Signal:Connect(Function)
	table.insert(StyleAloneHub.Connections, SignalConnect)
	return SignalConnect
end

task.spawn(function()
	while (StyleAloneHub:IsRunning()) do
		wait()
	end

	for _, Connection in next, StyleAloneHub.Connections do
...
local function CreateElement(ElementName, ElementFunction)
	StyleAloneHub.Elements[ElementName] = function(...)
		return ElementFunction(...)
	end
end

local function MakeElement(ElementName, ...)
	local NewElement = StyleAloneHub.Elements[ElementName](...)
	return NewElement
end
...
local function AddThemeObject(Object, Type)
	if not StyleAloneHub.ThemeObjects[Type] then
		StyleAloneHub.ThemeObjects[Type] = {}
	end    
	table.insert(StyleAloneHub.ThemeObjects[Type], Object)
	Object[ReturnProperty(Object)] = StyleAloneHub.Themes[StyleAloneHub.SelectedTheme][Type]
	return Object
end    

local function SetTheme()
	for Name, Type in pairs(StyleAloneHub.ThemeObjects) do
		for _, Object in pairs(Type) do
			Object[ReturnProperty(Object)] = StyleAloneHub.Themes[StyleAloneHub.SelectedTheme][Name]
		end    
	end    
end
...
local function LoadCfg(Config)
	...
	table.foreach(Data, function(a,b)
		if StyleAloneHub.Flags[a] then
			spawn(function() 
				if StyleAloneHub.Flags[a].Type == "Colorpicker" then
					StyleAloneHub.Flags[a]:Set(UnpackColor(b))
				else
					StyleAloneHub.Flags[a]:Set(b)
				end    
			end)
		else
...
local function SaveCfg(Name)
	local Data = {}
	for i,v in pairs(StyleAloneHub.Flags) do
		if v.Save then
	...
	writefile(StyleAloneHub.Folder .. "/" .. Name .. ".txt", tostring(HttpService:JSONEncode(Data)))
end
...
function StyleAloneHub:Init()
	if StyleAloneHub.SaveCfg then	
		pcall(function()
			if isfile(StyleAloneHub.Folder .. "/" .. game.GameId .. ".txt") then
				LoadCfg(readfile(StyleAloneHub.Folder .. "/" .. game.GameId .. ".txt"))
...
function StyleAloneHub:MakeWindow(WindowConfig)
	local FirstTab = true
	...
	WindowConfig.Name = WindowConfig.Name or "StyleAlone Library"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "StyleAlone Library"
	WindowConfig.CloseCallback = WindowConfig.CloseCallback or function() end
	WindowConfig.ShowIcon = WindowConfig.ShowIcon or false
	WindowConfig.Icon = WindowConfig.Icon or "rbxassetid://8834748103"
	WindowConfig.IntroIcon = WindowConfig.IntroIcon or "rbxassetid://8834748103"
	StyleAloneHub.Folder = WindowConfig.ConfigFolder
	StyleAloneHub.SaveCfg = WindowConfig.SaveConfig
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddButton(ButtonConfig)
				...
				AddConnection(Click.MouseEnter, function()
					TweenService:Create(ButtonFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(StyleAloneHub.Themes[StyleAloneHub.SelectedTheme].Second.R * 255 + 3, StyleAloneHub.Themes[StyleAloneHub.SelectedTheme].Second.G * 255 + 3, StyleAloneHub.Themes[StyleAloneHub.SelectedTheme].Second.B * 255 + 3)}):Play()
				end)

				AddConnection(Click.MouseLeave, function()
					TweenService:Create(ButtonFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = StyleAloneHub.Themes[StyleAloneHub.SelectedTheme].Second}):Play()
				end)
			...
			function ElementFunction:AddToggle(ToggleConfig)
				...
				function Toggle:Set(Value)
					Toggle.Value = Value
					TweenService:Create(ToggleBox, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Toggle.Value and ToggleConfig.Color or StyleAloneHub.Themes.Default.Divider}):Play()
					TweenService:Create(ToggleBox.Stroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Color = Toggle.Value and ToggleConfig.Color or StyleAloneHub.Themes.Default.Stroke}):Play()
